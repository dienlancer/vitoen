<div class="margin-top-5">
			...
			<?php 
			/*$source_featured_product=App\ProductModel::whereRaw('status = ? and price > ? and sale_off > ? and sale_price > ?',[1,0,0,0])->select('id','fullname','alias','image','alt_image','price','sale_price','sale_off')->orderBy('sale_off','asc')->take(99999)->get()->toArray();		*/					
			$source_featured_product=App\ProductModel::whereRaw('status = ?',[1])->select('id','fullname','alias','image','alt_image','price','sale_price','sale_off')->orderBy('id','desc')->take(20)->get()->toArray();		
					...
					<div class="owl-carousel featured-product owl-theme">
						...
						foreach($source_featured_product as $key2 => $value){
							...
							<div class="box-product-master margin-top-10">
								...
								<h3 class="box-product-intro-title"><center><a href="<?php echo $ft_product_permalink; ?>"><b><?php echo $ft_product_title; ?></b></a></center></h3>
								<?php 
								/* begin thương hiệu */		
								$trademark='';
